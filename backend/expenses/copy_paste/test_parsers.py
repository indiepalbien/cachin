...
Run from project root: python backend/expenses/copy_paste/test_parsers.py
"""
...
from backend.expenses.copy_paste.parsers import TransactionParser
from backend.expenses.copy_paste.validators import TransactionValidator
from backend.expenses.copy_paste.utils import load_yaml_config
